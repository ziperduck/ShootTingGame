...
AHealKit::AHealKit()
{
	...
	RootComponent = CreateDefaultSubobject<USceneComponent>(TEXT("AHealKit RootComponenet"));
}
...
{
	Super::BeginPlay();
	m_base_data = std::make_shared<FuselageCharacter>(this,10.0f,FuselageMaker::GetHealPack());
...
void AHealKit::NotifyActorBeginOverlap(AActor* Actor)
{
